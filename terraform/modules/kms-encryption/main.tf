...
data "aws_iam_policy_document" "kms_key_policy" {
  # checkov:skip=CKV_AWS_109: Key policy requires * for the resource it is attached to.
  # checkov:skip=CKV_AWS_111: Write access is restricted via the policy statements.
  # checkov:skip=CKV_AWS_356: Resource * is standard practice for KMS key policies.
